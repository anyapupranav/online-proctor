...
<table border="1" cellpadding="3" cellspacing="0" align="center">
	...
	<td id='tdcolour'><b>Employee Dept.</b></td>
	<td id='tdcolour'><b>E-mail</b></td>
	<td id='tdcolour'><b>Mobile Number</b></td>
	</tr>
	<?php
	...
	echo "<tr>";
	echo "<td>".$row['empid']."</td>"."<td>".$row['empname']."</td>"."<td>".$row['empdept']."</td>"."<td>".$row['empemail']."</td>"."<td>".$row['empmobile']."</td>";
	}
	echo "</tr>";
	}
	?>
...
<?php 
                ...
                if($page>1)
                {
                    echo "<a href='show_employee.php?page=".($page-1)."' class='btn btn-danger hero-button-wrapper'>Previous</a>";
                }

                
                for($i=1;$i<$total_page;$i++)
                {
                   // echo "<a href='show_employee.php?page=".$i."' class='btn btn-primary hero-button-wrapper'>$i</a>";
                }

                if($i>$page)
                {
		    echo "";
                    echo "<a href='show_employee.php?page=".($page+1)."' class='btn btn-danger hero-button-wrapper'>Next </a>";
