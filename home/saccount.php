...
$sql = "select * from studentsdetails where registernumber like '%$registernumber%'";
$result = $conn->query($sql);
...
<div id="hide">
	<table border="1" align="center"  cellspacing="2" cellpadding="8" width="70%">
		...
		<tr>
			<td class="fcbold" width="30%"><label>Student Name:</label></td>
			<td><?php echo "$sname"; ?></td>
		</tr>
		<tr>
			<td class="fcbold" width="30%"><label>Register Number:</label></td>
			<td><?php echo "$registernumber"; ?></td>
		</tr>
		<tr>
			<td class="fcbold" width="30%"><label>Department:</label></td>
			<td><?php echo "$dept"; ?></td>
		</tr>
		<tr>
			<td class="fcbold" width="30%"><label>Date of Birth:</label></td>
			<td><?php echo "$dob"; ?></td>
		</tr>
		<tr>
			<td class="fcbold" width="30%"><label>E-Mail ID:</label></td>
			<td><?php echo "$pemail"; ?></td>
		</tr>
		<tr>
			<td class="fcbold" width="30%"><label>Mobile Number:</label></td>
